...
export const terms: Localized<PageContent> = {
  en: {
    ...
    intro: "These terms govern your use of Smart Market (Smarttrustexpress), operated by Godwin Tech Solution. By creating an account you agree to them.",
    sections: [
      { heading: "1. The service", paragraphs: ["Smart Market is an online marketplace connecting independent sellers and buyers. Smart Market holds payments in escrow but is not a party to the sale itself, except for the dispute process described below."] },
      ...
      { heading: "5. Escrow and payouts", paragraphs: ["Funds are released to the seller's wallet only after both parties confirm, or after a dispute decision. Sellers withdraw to their own Mobile Money number. Smart Market may charge a platform commission on completed orders; any commission is shown before you publish."] },
      { heading: "6. Disputes", paragraphs: ["Either party may open a dispute on a paid order. Smart Market's decision, made in good faith on the available evidence, is binding for the release or refund of the escrowed amount."] },
      ...
      { heading: "9. Liability", paragraphs: ["Smart Market is provided as is. To the extent permitted by law, our liability is limited to the amount held in escrow for the order concerned."] },
      { heading: "10. Changes and contact", paragraphs: ["We may update these terms; material changes are announced on the site. Questions: support@smartmarket.dev."] },
    ],
  },
  fr: {
    ...
    intro: "Ces conditions régissent votre utilisation de Smart Market (Smarttrustexpress), exploitée par Godwin Tech Solution. En créant un compte, vous les acceptez.",
    sections: [
      { heading: "1. Le service", paragraphs: ["Smart Market est une marketplace en ligne qui met en relation des vendeurs indépendants et des acheteurs. Smart Market conserve les paiements sous séquestre mais n'est pas partie à la vente elle-même, en dehors du processus de litige décrit ci-dessous."] },
      ...
      { heading: "5. Séquestre et retraits", paragraphs: ["Les fonds sont libérés vers le portefeuille du vendeur uniquement après confirmation des deux parties, ou après décision sur un litige. Les vendeurs retirent vers leur propre numéro Mobile Money. Smart Market peut prélever une commission sur les commandes terminées ; toute commission est affichée avant publication."] },
      { heading: "6. Litiges", paragraphs: ["Chaque partie peut ouvrir un litige sur une commande payée. La décision de Smart Market, prise de bonne foi sur les éléments disponibles, s'impose pour la libération ou le remboursement du montant sous séquestre."] },
      ...
      { heading: "9. Responsabilité", paragraphs: ["Smart Market est fourni en l'état. Dans la limite permise par la loi, notre responsabilité est limitée au montant sous séquestre pour la commande concernée."] },
      { heading: "10. Modifications et contact", paragraphs: ["Nous pouvons mettre à jour ces conditions ; les changements importants sont annoncés sur le site. Questions : support@smartmarket.dev."] },
    ],
  },
};
...
export const privacy: Localized<PageContent> = {
  en: {
    ...
    sections: [
      ...
      { heading: "Who sees it", bullets: ["Sellers see the name and delivery details of buyers who ordered from them.", "Payment operators (MTN, Orange via K-Pay) receive the phone number and amount needed to process a payment.", "Email is delivered through Resend. Images are stored on Cloudflare R2.", "Smart Market staff access data only to operate the service and resolve disputes; every access is logged."] },
      { heading: "Your rights", bullets: ["Access, correct or delete your personal data by writing to support@smartmarket.dev.", "Unsubscribe from the newsletter at any time.", "Transaction records may be kept as long as required by law or open disputes."] },
      ...
      { heading: "Contact", paragraphs: ["Data controller: Godwin Tech Solution, Douala, Cameroon — privacy@smartmarket.dev."] },
    ],
  },
  fr: {
    ...
    sections: [
      ...
      { heading: "Qui y a accès", bullets: ["Les vendeurs voient le nom et les informations de livraison des acheteurs qui leur ont commandé.", "Les opérateurs de paiement (MTN, Orange via K-Pay) reçoivent le numéro et le montant nécessaires au traitement.", "Les e-mails sont envoyés via Resend. Les images sont stockées sur Cloudflare R2.", "L'équipe Smart Market n'accède aux données que pour exploiter le service et résoudre les litiges ; chaque accès est journalisé."] },
      { heading: "Vos droits", bullets: ["Accéder, corriger ou supprimer vos données personnelles en écrivant à support@smartmarket.dev.", "Vous désinscrire de la newsletter à tout moment.", "Les enregistrements de transaction peuvent être conservés aussi longtemps que la loi ou un litige ouvert l'exige."] },
      ...
      { heading: "Contact", paragraphs: ["Responsable du traitement : Godwin Tech Solution, Douala, Cameroun — privacy@smartmarket.dev."] },
    ],
  },
};
